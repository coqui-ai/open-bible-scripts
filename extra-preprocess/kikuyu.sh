...
echo "I: extra pre-processing for Kikuyu to fix filenames."
...
mv 05_Deuteronomy	DEU;	rename 's/05_Deutronomy/DEU/' DEU/*.wav;
...
mv 09_1Samuel	1SA;	rename 's/09_1Samuel/1SA/' 1SA/*.wav;
mv 10_2Samuel	2SA;	rename 's/10_2Samuel/2SA/' 2SA/*.wav;
mv 11_1Kings	1KI;	rename 's/11_1Kings/1KI/' 1KI/*.wav;
mv 12_2Kings	2KI;	rename 's/12_2Kings/2KI/' 2KI/*.wav;
mv 13_1Chronicles	1CH;	rename 's/13_1Chronicles/1CH/' 1CH/*.wav;
mv 14_2Chronicles	2CH;	rename 's/14_2Chronicles/2CH/' 2CH/*.wav;
...
mv 26_Ezekiel	EZK;	rename 's/26_Ezekiel/EZK/' EZK/*.wav;
...
mv 46_1Corinthians	1CO;	rename 's/46_1Corinthians/1CO/' 1CO/*.wav;
mv 47_2Corinthians	2CO;	rename 's/47_2Corinthians/2CO/' 2CO/*.wav;
...
mv 52_1Thessalonians	1TH;	rename 's/52_1Thessalonians/1TH/' 1TH/*.wav;
mv 52_2Thessalonians	2TH;	rename 's/53_2Thessalonians/2TH/' 2TH/*.wav;
mv 54_1Timothy	1TI;	rename 's/54_1Timothy/1TI/' 1TI/*.wav;
mv 55_2Timothy	2TI;	rename 's/55_2Timothy/2TI/' 2TI/*.wav;
...
mv 60_1Peter	1PE;	rename 's/60_1Peter/1PE/' 1PE/*.wav;
mv 61_2Peter	2PE;	rename 's/61_2Peter/2PE/' 2PE/*.wav;
mv 62_1John	1JN;	rename 's/62_1John/1JN/' 1JN/*.wav;
mv 63_2John	2JN;	rename 's/63_2John/2JN/' 2JN/*.wav;
mv 64_3John	3JN;	rename 's/64_3John/3JN/' 3JN/*.wav;
mv 65_Jude	JUD;	rename 's/65_Jude/JUD/' JUD/*.wav;
mv 66_Revelation	REV;	rename 's/66_Revelation/REV/' REV/*.wav;
rename 's/ /_/' */*.wav;
rename 's/_V[0-9]//' */*.wav;
rename 's/ //' PSA/PSA_121.wav
rename 's/_0+/_/' */*.wav
rename 's/__/_/' */*.wav
